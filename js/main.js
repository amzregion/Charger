...
//<Определяет может ли браузер читать WebP изображения>===================================================================================================
...
$(document).ready(function () {
	...
	$('.gifts__leade-item').slick({
		slidesToShow: 1,
		slidesToScroll: 1,
		arrows: false,
		fade: true,
		asNavFor: '.gifts__sub-slider',
		autoplay: true,
	});

	$('.gifts__sub-slider').slick({
		//arrows: false,
		slidesToShow: 3,
		slidesToScroll: 1,
		asNavFor: '.gifts__leade-item',
		centerMode: true,
		arrows: false,
		focusOnSelect: true,
	});
...
function initRaitings() {
	...
	function initRaiting(raiting) {
		...
		if (raiting.classList.contains('raiting_set')) {
			setRaiting(raiting);
		}
	}
